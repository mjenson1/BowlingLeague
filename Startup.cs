...
namespace BowlingLeague
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints => //making all the diff url endpoints
            {
            endpoints.MapControllerRoute("teampagenum",
                "TeamName/{teamnombre}/{TeamName}/{pagenum}",
                new { Controller = "Home", action = "Index" });

            endpoints.MapControllerRoute("teamnombre",
                "TeamName/{teamnombre}/{TeamName}",
